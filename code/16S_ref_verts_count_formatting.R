...
####################                    16S Verts Count                     ####################
GRDI_data1 <- read.table("data/comparison/merged_16S_rel_verts_count_for_formatting.txt", header=TRUE)
View(GRDI_data1)
dim(GRDI_data1)
#30, 109
...
verts_count_16S_rel_formatted<-rbind(Sample1,Sample2,Sample3,Sample4,Sample5,Sample6,Sample7,Sample8,Sample9,Sample10,Sample11,Sample12,
...
write.csv(verts_count_16S_rel_formatted,'data/comparison/verts_count_16S_rel_formatted.csv')
