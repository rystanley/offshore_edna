...
####################                    16S Verts wgt                     ####################
GRDI_data1 <- read.table("data/comparison/merged_16S_verts_wgt_for_formatting.txt", header=TRUE)
View(GRDI_data1)
dim(GRDI_data1)
#30, 109
...
verts_wgt_16S_formatted<-rbind(Sample1,Sample2,Sample3,Sample4,Sample5,Sample6,Sample7,Sample8,Sample9,Sample10,Sample11,Sample12,
...
write.csv(verts_wgt_16S_formatted,'data/comparison/verts_wgt_16S_formatted.csv')
